...
type Service struct {
	...
	ExpectedHeadersNegated bool                  `gorm:"default:false;column:negate_expected_headers" json:"negate_expected_headers" scope:"user,admin" yaml:"negate_expected_headers"`
