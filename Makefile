...
TEST_DIR=$(GOPATH)/src/github.com/handelsblattgroup/statping
...
lint:
	go fmt ./...
	golint ./...
	impi --local github.com/handelsblattgroup/statping/ --scheme stdLocalThirdParty ./...
	goimports ./...
...
download-bins: clean
	mkdir build || true
	wget "https://github.com/handelsblattgroup/statping/releases/download/v${VERSION}/statping-linux-386.tar.gz"
	wget "https://github.com/handelsblattgroup/statping/releases/download/v${VERSION}/statping-linux-amd64.tar.gz"
	wget "https://github.com/handelsblattgroup/statping/releases/download/v${VERSION}/statping-linux-arm.tar.gz"
	wget "https://github.com/handelsblattgroup/statping/releases/download/v${VERSION}/statping-linux-arm64.tar.gz"
